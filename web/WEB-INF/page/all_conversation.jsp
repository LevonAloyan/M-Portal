    ...
    <div class="row row-offcanvas row-offcanvas-left">
        <%--<div id="scon" class="col-sm-2 col-md-3 sidebar-offcanvas" role="navigation">--%>
            <%--<div class="sidebar-nav">--%>
                ...
                <%--<ul class="nav">--%>
                    <%--<li class="home"><a href="user.action"><span class="badge"><span--%>
                            <%--class="glyphicon glyphicon-home"></span></span> <span class="nav-label">My Dashboard</span></a>--%>
                    <%--</li>--%>
                    <%--&lt;%&ndash;<li><a href="profile.action"><span class="badge"><span class="glyphicon glyphicon-cog"></span></span>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<span class="nav-label">Profile &amp; Settings</span></a></li>&ndash;%&gt;--%>
                    ...
                    <%--&lt;%&ndash;<li><a href="/my/groups"><span class="badge"><span class="glyphicon glyphicon-user"></span></span>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<span class="nav-label">My Groups</span></a></li>&ndash;%&gt;--%>
            ...
            <%--</div>--%>
        <%--</div>--%>
        <div id="pcon" class="col-sm-offset-4 col-md-9 col-md-offset-3" style="margin-left: 145px!important">
            ...
            <div class="mm-wgt panel panel-default pos-relative">
                ...
                <div class="panel-body media ">
                    ...
                    <div class="media-body">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <strong><a href="profile.action">Ruben
                                    Sharyan</a></strong><br/>
